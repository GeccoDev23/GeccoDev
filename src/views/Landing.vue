            ...
            <section class="section-shaped my-0">
                ...
                <div class="container shape-container d-flex">
                    <div class="col px-0">
                        <div class="row">
                            <div class="col-lg-7">
                                <h1 class="display-3  text-white">A beautiful Designing Partner
                                    <span>We Design your Vision</span>
                                </h1>
                                <p class="lead  text-white">We bring the customized design and System according to your needs. You provide us the requirements  and you're good to
                                    go.</p>
                                <div class="btn-wrapper">
                                    ...
                                    <router-link to="/quotatiom" class="btn btn-neutral btn-icon ">
                        <span class="nav-link-inner--text"> Request Quotation</span>
                    </router-link>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row row-grid">
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <h6 class="text-primary text-uppercase">Design Website</h6>
                                    <p class="description mt-3">We bring the customized design and System according to your needs. You provide us the requirements  and you're good to
                                    go.</p>
                                    <div>
                ...
                <div class="row row-grid align-items-center">
                    ...
                    <div class="col-md-6 order-md-1">
                        <div class="pr-md-5">
                            ...
                            <p>We bring the customized design and System according to your needs. You provide us the requirements  and you're good to
                                    go.</p>
                            <ul class="list-unstyled mt-5">
                                <li class="py-2">
                                    <div class="d-flex align-items-center">
                                        <badge type="success" circle class="mr-3" icon="ni ni-settings-gear-65"></badge>
                                        <h6 class="mb-0">Carefully crafted designs</h6>
                                    </div>
                                </li>
                                <li class="py-2">
                                    <div class="d-flex align-items-center">
                                        <badge type="success" circle class="mr-3" icon="ni ni-html5"></badge>
                                        <h6 class="mb-0">Amazing pages</h6>
                                    </div>
                                </li>
                                <li class="py-2">
                                    <div class="d-flex align-items-center">
                                        <badge type="success" circle class="mr-3" icon="ni ni-satisfied"></badge>
                                        <h6 class="mb-0">Super friendly user experience</h6>
                                    </div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row row-grid align-items-center">
                        ...
                        <div class="card bg-default shadow border-0">
                            ...
                            <blockquote class="card-blockquote">
                                <svg preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 583 95"
                                     class="svg-bg">
                                    <polygon points="0,12 583,100 0,100" class="fill-default"></polygon>
                                    <polygon points="0,42 583,95 683,0 0,95" opacity=".2" class="fill-default"></polygon>
                                </svg>
                                <h4 class="display-3 font-weight-bold text-white">Design System</h4>
                                <p class="lead text-italic text-white">We bring the customized design and System according to your needs. You provide us the requirements  and you're good to
                                    go.</p>
                            </blockquote>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="pl-md-5">
                            ...
                            <h3>Our customers</h3>
                            <p class="lead">We bring the customized design and System according to your needs. You provide us the requirements  and you're good to
                                    go.</p>
                            <p>We bring the customized design and System according to your needs. You provide us the requirements  and you're good to
                                    go.</p>
                            <p>We bring the customized design and System according to your needs. You provide us the requirements  and you're good to
                                    go.</p>
                            <a href="#" class="font-weight-bold text-warning mt-5">A beautiful approach for impactful
                                websites</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6 order-lg-1">
                        <div class="d-flex px-3">
                            ...
                            <div class="pl-4">
                                ...
                                <p class="text-white">We bring the customized design and System according to your needs. You provide us the requirements  and you're good to
                                    go.</p>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="row justify-content-center text-center mb-lg">
                    <div class="col-lg-8">
                        ...
                        <p class="lead text-muted">We bring the customized design and System according to your needs. You provide us the requirements  and you're good to
                                    go.</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
                        <div class="px-6">
                            ...
                            <div class="pt-4 text-center">
                                <h5 class="title">
                                    <span class="d-block mb-1">Prithvi Bhattarai</span>
                                    <small class="h6 text-muted">Administrative Strategist</small>
                                </h5>
                                <div class="mt-3">
                    ...
                    <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
                        <div class="px-6">
                            ...
                            <div class="pt-4 text-center">
                                <h5 class="title">
                                    <span class="d-block mb-1">Ganesh Ranabhat</span>
                    ...
                    <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
                        <div class="px-6">
                            ...
                            <div class="pt-4 text-center">
                                <h5 class="title">
                                    <span class="d-block mb-1">Ayush Shrestha</span>
                    ...
                    <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
                        <div class="px-6">
                            ...
                            <div class="pt-4 text-center">
                                <h5 class="title">
                                    <span class="d-block mb-1">Roshan Bagale</span>
                ...
                <div class="row row-grid justify-content-center">
                    <div class="col-lg-8 text-center">
                        <div class="text-center">
                            <h4 class="display-3 mb-5 mt-5">Available on these technologies</h4>
                            <div class="row justify-content-center">
